...
constant uint kMappingGlyphs[12] =
{
    31599u, 29850u, 29671u, 31207u, 18925u, 31183u, 31695u, 18727u, 31727u, 31215u, 1040u, 2728u
};

static inline float mappingGlyph(float2 p, int glyph)
{
...
static inline float mappingAspectLabel(float2 p, float2 origin, bool portrait)
{
...
static inline float mappingRasterLabel(float2 p)
{
...
static inline float3 ledMapping(float2 uv)
{
